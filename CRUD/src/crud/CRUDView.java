 ...
 */
public class CRUDView extends FrameView {
    
    public CRUDView(SingleFrameApplication app) {
        super(app);
    ...
    public void newRecord() {
        crud.Employee e = new crud.Employee();
    ...
    public void deleteRecord() {
        ...
        List<crud.Employee> toRemove = new ArrayList<crud.Employee>(selected.length);
        for (int idx=0; idx<selected.length; idx++) {
            crud.Employee e = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(e);
    ...
    private class SaveTask extends Task {
        ...
        @Override protected Void doInBackground() {
            try {
                ...
                rex.printStackTrace();
                entityManager.getTransaction().begin();
                List<crud.Employee> merged = new ArrayList<crud.Employee>(list.size());
                for (crud.Employee e : list) {
    ...
    public void showAboutBox() {
        if (aboutBox == null) {
            JFrame mainFrame = CRUDApp.getApplication().getMainFrame();
            aboutBox = new CRUDAboutBox(mainFrame);
            aboutBox.setLocationRelativeTo(mainFrame);
        }
        CRUDApp.getApplication().show(aboutBox);
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(crud.CRUDApp.class).getContext().getResourceMap(CRUDView.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(crud.CRUDApp.class).getContext().getActionMap(CRUDView.class, this);
        ...
        mainPanelLayout.setHorizontalGroup(
            ...
            .addGroup(mainPanelLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(employeeIdField, javax.swing.GroupLayout.DEFAULT_SIZE, 315, Short.MAX_VALUE)
    ...
    private java.util.List<crud.Employee> list;
