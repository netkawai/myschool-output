    ...
    throws ServletException, IOException {
       ...
       HttpSession sn = request.getSession();
        try {
            ...
            Query query =em.createQuery("DELETE FROM Employee e WHERE e.employeeId = :employeeId");
            query.setParameter("employeeId",((Integer)sn.getAttribute("empId")).intValue());
